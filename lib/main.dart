import 'package:bloc_number/bloc/counter_bloc.dart';
      ...
      body: BlocBuilder<CounterBloc, CounterStates>(
        builder: (context, state) {
          if (state is InitialState) {
            //si esta en un estado inicial enviar 0  de parametro
            ...
            children: [
              MaterialButton(
                  ...
                  onPressed: () {
                    context
                        .read<CounterBloc>()
                        .add(NumberDecreaseEvent(number));
                  }),
              const SizedBox(
                width: 50,
              ),
              MaterialButton(
                ...
                onPressed: () {
                  context.read<CounterBloc>().add(NumberIncreaseEvent(number));
                },
              ),
            ],
          ),
